...
export const metadata: Metadata = {
  ...
  description:
    "판매·수익성 분석, 기관 문서업무, 기업 운영과 개발팀 업무를 역할별 AI Worker로 확장하세요. 승인된 지식과 도구를 연결하고 중요한 결정은 사람에게 남깁니다.",
  icons: {
  ...
  openGraph: {
    ...
    description: "판매·매입 데이터 분석 · 역할별 Worker · 사람 중심의 검토와 결정",
    type: "website",
    url: publishedUrl,
    images: [{
      ...
      width: 1729,
      height: 910,
      alt: "사람의 질문을 Data Analysis Worker가 검토 가능한 판매·수익성 분석 결과로 준비하는 Worker Host 활용 구조",
    }],
  },
  twitter: {
