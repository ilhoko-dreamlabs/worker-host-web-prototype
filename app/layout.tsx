...
export const metadata: Metadata = {
  ...
  description:
    "제품 기획, 개발, QA와 운영 업무를 역할별 AI Worker로 확장하세요. 팀의 지식과 도구를 연결하고, 중요한 결정은 사람에게 남깁니다.",
  icons: {
  ...
  openGraph: {
    ...
    url: publishedUrl,
    images: [{
      url: `${publishedUrl}og.png`,
      width: 1744,
      height: 909,
      alt: "사람이 역할별 Worker에 독립 요청을 보내는 Worker Host 구조",
    }],
  },
  twitter: {
